        ...
        <div class="category fl <?php if($_show_nav == 0) echo 'cat1'; ?>">
            ...
            <div class="cat_bd <?php if($_show_nav == 0) echo 'none'; ?>">
                ...
                <div class="cat <?php if($k==0) echo 'item1'; ?>">
                    <h3><a href=""><?php echo $v['name'];?></a> <b></b></h3>
                    <div class="cat_detail none">
                        <?php foreach ($v['children'] as $k1 => $v1): ?>
                        <dl <?php if($k1==0) echo 'class="dl_1st"'; ?>>
                        <dt><a href=""><?php echo $v1['name'];?></a></dt>
                        <dd>
                            <?php foreach ($v1['children'] as $k2 => $v2): ?>
                            <a href=""><?php echo $v2['name'];?></a>
                            <?php endforeach; ?>
                        </dd>
                        </dl>
                        <?php endforeach; ?>
                ...
                <div class="fare">
                    <form action="">
                        <ul>
                            ...
                            <li>
                                <label for="">&nbsp;</label>
                                <input type="submit" value="点击充值" class="fare_btn"/> <span><a
                                    href="">北京青春怒放独家套票</a></span>
                            </li>
                        </ul>
                    </form>
                </div>
        ...
        <div class="guide_wrap">
            ...
            <div class="crazy">
                <ul>
                    ...
                    <li>
                        <dl>
                            <dt><a href="<?php echo U('goods?id='.$v['id']); ?>"><?php showImage($v['mid_logo']); ?></a>
                            </dt>
                            <dd><a href="<?php echo U('goods?id='.$v['id']); ?>"><?php echo $v['goods_name']; ?></a>
                            </dd>
    ...
    <div class="floor_left fl">
        ...
        <div class="cate fl">
            ...
            <div class="cate_wrap">
                <ul>
                    ...
                    <li><a href=""><b>.</b><?php echo $v1['name']; ?></a></li>
                    <?php endforeach; ?>
                </ul>
        ...
        <div class="goodslist fl">
            <h2>
                ...
                <span <?php if($k1==0) echo 'class="on"'; ?>><?php echo $v1['name']; ?></span>
                <?php endforeach; ?>
            </h2>
            <div class="goodslist_wrap">
                ...
                <?php foreach ($v['recSubCat'] as $k1 => $v1): ?>
                <div
                <?php if($k1 > 0) echo 'class="none"'; ?>>
                <ul>
                    <?php foreach ($v1['goods'] as $k2 => $v2): ?>
                    <li>
                        <dl>
                            <dt>
                                <a href="<?php echo U('goods?id='.$v2['id']); ?>"><?php showImage($v2['mid_logo']); ?></a>
                            </dt>
                            <dd><a href="<?php echo U('goods?id='.$v2['id']); ?>"><?php echo $v2['goods_name']; ?></a>
                            </dd>
