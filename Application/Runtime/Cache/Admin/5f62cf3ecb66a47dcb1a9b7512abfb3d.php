...
<head>
    ...
    <style type="text/css">
        ...
        .explode {
            background: url(/Public/Admin/Images/menu_minus.gif) no-repeat 0 3px;
            font-weight: bold;
        }

        .collapse {
            background: url(/Public/Admin/Images/menu_plus.gif) no-repeat 0 3px;
            font-weight: bold;
        }

        .menu-item {
            background: url(/Public/Admin/Images/menu_arrow.gif) no-repeat 0 3px;
            font-weight: normal;
        }
    ...
    <p>
        <span style="float:right; padding:3px 5px;">
            <a href="javascript:toggleCollapse();">
                <img id="toggleImg" src="/Public/Admin/Images/menu_minus.gif" width="9" height="9" border="0"
                     alt="闭合"/>
            </a>
        </span>
        ...
        <ul id="menu-ul">
            <li class="explode" key="02_cat_and_goods" name="menu">
                ...
                <ul>
                    ...
                    <li class="menu-item"><a href="/index.php/Admin/Goods/add" target="main-frame">添加商品</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Category/lst" target="main-frame">商品分类</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Brands/lst" target="main-frame">商品品牌</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Type/lst" target="main-frame">类型列表</a></li>
...
<!--            </li>-->
            <li class="explode" key="08_members" name="menu">
                会员管理
                <ul>
                    <li class="menu-item"><a href="/index.php/Admin/MemberLevel/lst" target="main-frame">会员积分</a></li>
...
<!--                    <li class="menu-item"><a href="userMessage.html" target="main-frame">会员留言</a></li>-->
            ...
            <li class="explode" key="02_cat_and_goods" name="menu">
                RBAC
                <ul>
                    <li class="menu-item"><a href="/index.php/Admin/Privilege/lst" target="main-frame">权限列表</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Role/lst" target="main-frame">角色列表</a></li>
                    <li class="menu-item"><a href="/index.php/Admin/Admin/lst" target="main-frame">管理员列表</a></li>
                </ul>
            </li>
        </ul>
    </div>
...
<script language="JavaScript" type="application/javascript">
    ...
    document.getElementById('tabbar-div').onclick = function (e) {
        const obj = Utils.srcElement(e);
        const hlpTab = document.getElementById('help-tab');
        const mnuDiv = document.getElementById('menu-list');
        const hlpDiv = document.getElementById('help-div');
                ...
                if (document.getCookie(this.CookieName) != null) {
                    ...
                    for (let i = 0; i < items.length; i++) {
                        if (items[0].getAttribute("name") == "menu" && items[0].getAttribute("id") != '20_yun') {
                            for (let k in this.SourceObject) {
