                ...
                <tr>
                    ...
                    <td>
                        <select name="pid">
                            ...
                            <?php if(is_array($lst)): foreach($lst as $key=>$lo): if($lo["none"] != 1): ?><option value="<?php echo ($lo["id"]); ?>" <?php if(($data['pid']) == $lo["id"]): ?>selected="selected"<?php endif; ?>><?php echo ($lo["name"]); ?></option><?php endif; endforeach; endif; ?>
                        </select>
                    </td>
                </tr>
                <tr>
